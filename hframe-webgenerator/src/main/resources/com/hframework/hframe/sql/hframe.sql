...
) ENGINE=InnoDB AUTO_INCREMENT=151031888613 DEFAULT CHARSET=utf8 COMMENT='实体属性';


CREATE TABLE `hfmd_entity_join_rule` (
  `hfmd_entity_join_rule_id` bigint(20) NOT NULL DEFAULT '0',
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='常用实体属性';
...
CREATE TABLE `test2` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='234';
...
CREATE TABLE `test34` (
  ...
  `modify_time` datetime DEFAULT NULL COMMENT '修改时间',
  PRIMARY KEY (`hfpm_data_field_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COMMENT='数据列';
