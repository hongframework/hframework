...
public class EntityAttr {
    ...
    private Map<String,String> oldProperty = new HashMap<String, String>();

    public EntityAttr(Long hfmdEntityAttrId, String hfmdEntityAttrName, String hfmdEntityAttrCode, String hfmdEntityAttrDesc, Integer attrType, String size, Integer ispk, Integer nullable, Integer isBusiAttr, Integer isRedundantAttr, Long relHfmdEntityAttrId, Long hfmdEnumClassId, BigDecimal pri, Long hfpmProgramId, Long hfpmModuleId, Long hfmdEntityId, Long opId, Date createTime, Long modifyOpId, Date modifyTime, Integer delFlag) {
    ...
    public void setOldProperty(Map<String, String> oldProperty) {
