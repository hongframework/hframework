...
public class Entity {
    ...
    public Entity(Long hfmdEntityId, String hfmdEntityName, String hfmdEntityCode, Integer hfmdEntityType, String hfmdEntityDesc, Long hfpmProgramId, Long hfpmModuleId, Long opId, Date createTime, Long modifyOpId, Date modifyTime, Integer delFlag) {
