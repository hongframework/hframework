...
public class Module {
    ...
    public Module(Long hfpmModuleId, String hfpmModuleName, String hfpmModuleCode, String hfpmModuleDesc, Long hfpmProgramId, Long opId, Date createTime, Long modifyOpId, Date modifyTime, Integer delFlag) {
