...
public class EntityRel {
    ...
    public EntityRel(Long hfmdEntityRelId, Long hfmdEntityId, Integer hfmdEntityRelType, Integer hfmdEntityRelLevel, String hfmdEntityRelDesc, Long relHfmdEntityId, Long relEntityAttrId, Long hfpmProgramId, Long opId, Date createTime, Long modifyOpId, Date modifyTime, Integer delFlag) {
