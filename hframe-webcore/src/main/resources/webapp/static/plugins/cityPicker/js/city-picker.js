...
(function (factory) {
    ...
    CityPicker.prototype = {
        ...
        render: function () {
            var p = this.getPosition(),
                ...
                provinceName = this.$element.attr('provinceName') || "省份",
                cityName = this.$element.attr('cityName') || "城市",
                districtName = this.$element.attr('districtName') || "区县",
                ...
                dropdown = '<div class="city-picker-dropdown" style="left:0px;top:100%;' +
                    ...
                    '<a class="active" data-count="province">' + provinceName + '</a>' +
                    (this.includeDem('city') ? '<a data-count="city">' + cityName + '</a>' : '') +
                    (this.includeDem('district') ? '<a data-count="district">' + districtName +'</a>' : '') + '</div>' +
    ...
    $.fn.citypicker = function (treeData, option) {
        if (treeData) {
            ChineseDistricts = treeData;
        }
